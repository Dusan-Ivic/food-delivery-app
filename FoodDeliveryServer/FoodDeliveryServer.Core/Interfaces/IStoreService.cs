...
namespace FoodDeliveryServer.Core.Interfaces
{
    public interface IStoreService
    {
        ...
        public Task<CreateStoreResponseDto> CreateStore(long partnerId, StoreRequestDto requestDto);
        public Task<UpdateStoreResponseDto> UpdateStore(long id, long partnerId, StoreRequestDto requestDto);
